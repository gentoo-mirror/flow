...
SRC_URI="elibc_mintlib? ( mirror://gentoo/${PN}-1.42.9-mint-r1.patch.xz )"
EGIT_REPO_URI="git://git.kernel.org/pub/scm/fs/ext2/e2fsprogs.git https://kernel.googlesource.com/pub/scm/fs/ext2/e2fsprogs.git https://git.kernel.org/pub/scm/fs/ext2/e2fsprogs.git"
EGIT_COMMIT="0f26747167cc9d82df849b0aad387bf824f04544"
...
IUSE="+e4crypt nls static-libs elibc_FreeBSD"

RDEPEND="~sys-libs/${PN}-libs-1.42.13
...
src_prepare() {
	...
	use e4crypt && epatch "${FILESDIR}"/${PN}-remove-barrier.patch
